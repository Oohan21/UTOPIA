...
export default function RegisterPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    // All users register as 'user' type by default
    // Only existing admins can create admin accounts through admin panel
    const registrationData = {
      ...
      user_type: "user", // Fixed as 'user' for registration
    };
